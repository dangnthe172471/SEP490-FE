...
import { Calendar, Users, UserPlus, Activity, Search, Phone, Mail } from "lucide-react"
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Tra cứu và quản lý thông tin bệnh nhân</p>
          </div>
          <Button onClick={() => router.push("/reception/register")}>
              ...
              <CardContent className="p-6">
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex gap-2 ml-4">
                    <Button size="sm" onClick={() => router.push(`/reception/patients/${patient.id}`)}>
                      Xem chi tiết
                    </Button>
                    <Button
                      size="sm"
                      variant="outline"
                      onClick={() => router.push(`/reception/appointments/new?patientId=${patient.id}`)}
                    >
                      Đặt lịch
                    </Button>
                  </div>
