...
import { ArrowLeft, Loader2, Shield, Timer, Mail } from "lucide-react"
                    ...
                    <Card className="border-none bg-white shadow-2xl ring-1 ring-black/5">
                        <CardHeader className="space-y-3 pb-8">
                            <div className="flex items-center gap-3">
                                ...
                                <CardTitle className="text-3xl font-bold">Xác thực Email</CardTitle>
                            </div>
            ...
            <div className="relative hidden lg:block lg:w-1/2">
                ...
                <div className="relative flex h-full flex-col justify-center px-20 text-primary-foreground">
                    <div className="max-w-lg space-y-10">
                        ...
                        <h2 className="text-5xl font-bold leading-tight">Xác thực email của bạn</h2>
                        <p className="text-xl leading-relaxed opacity-95">
                            Nhập mã xác thực 6 chữ số đã được gửi đến email của bạn để hoàn tất đăng ký tài khoản.
                        </p>
                    </div>
                </div>
            </div>
