...
export function Header() {
  ...
  return (
    ...
    >
      {/* Top bar */}
      <div
        className={`bg-primary text-primary-foreground transition-all duration-300 ${isScrolled ? "py-1" : "py-2"}`}
        suppressHydrationWarning
      >
          ...
          >
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium">Hotline: 0999-999-999</span>
              </div>
      ...
      <div className="container mx-auto px-4" suppressHydrationWarning>
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col">
              <span className="font-serif text-xl font-bold leading-none text-foreground">
                Diamond Health
              </span>
              ...
              return (
                <button
                  ...
                  className={`relative text-sm font-medium transition-all duration-200 hover:text-primary ${
                    ...
                    isChatItem
                      ? "flex items-center gap-1 bg-primary/10 px-3 py-1 rounded-full hover:bg-primary/20"
                      : ""
                  }`}
                >
                  {isChatItem && <MessageCircle className="h-3 w-3" />}
                  {item.label}
                  {isActive(item.href) && !isChatItem && (
        ...
        {mobileMenuOpen && (
          <div
            className="animate-in slide-in-from-top-2 border-t py-4 md:hidden"
            suppressHydrationWarning
          >
                ...
                return (
                  <button
                    ...
                    className={`text-sm font-medium transition-all duration-200 hover:text-primary hover:translate-x-1 ${
                      ...
                      isChatItem
                        ? "flex items-center gap-2 bg-primary/10 px-3 py-2 rounded-lg hover:bg-primary/20"
                        : ""
                    }`}
                  >
